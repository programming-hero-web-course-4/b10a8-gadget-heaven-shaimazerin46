    ...
    return (
       <div>
        ...
        <Helmet>
            ...
            <div className=" text-white text-center p-5 w-[800px] mx-auto">
                <h3 className="font-bold text-3xl mb-5">Dashboard</h3>
                <p className='mb-3'>Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!</p>
                <div className='mt-7'>
